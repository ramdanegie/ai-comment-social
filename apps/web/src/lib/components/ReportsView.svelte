  ...
  <div class="flex flex-col justify-between gap-4 sm:flex-row sm:items-center">
    ...
    <div class="flex items-center gap-3">
      <div class="flex rounded-xl border border-slate-200 bg-white p-1 text-xs font-semibold dark:border-slate-800 dark:bg-slate-900">
        <button
          type="button"
          class="rounded-lg px-3 py-1.5 transition {period === 'daily' ? 'bg-[#ea4335] text-white shadow-2xs' : 'text-slate-600 dark:text-slate-300'}"
        ...
        <button
          type="button"
          class="rounded-lg px-3 py-1.5 transition {period === 'weekly' ? 'bg-[#ea4335] text-white shadow-2xs' : 'text-slate-600 dark:text-slate-300'}"
      ...
      <button
        type="button"
        class="inline-flex items-center gap-1.5 rounded-xl bg-slate-900 px-4 py-2 text-xs font-semibold text-white shadow-xs transition hover:bg-slate-800 active:scale-95 dark:bg-[#ea4335] dark:hover:bg-[#d93025]"
  ...
  <div class="grid grid-cols-1 gap-4.5 sm:grid-cols-3">
    ...
    <div class="soft-card p-5.5">
      ...
      <div class="mt-4 space-y-2 text-xs">
        ...
        <div>
          <div class="flex justify-between">
            <span class="text-[#b3261e] dark:text-red-400 font-medium">Risiko (SARA/Ancaman)</span>
          ...
          <div class="mt-1 h-1.5 w-full rounded-full bg-slate-100 dark:bg-slate-800">
            <div class="h-full rounded-full bg-[#ea4335]" style="width: {totalVolume > 0 ? (totalRisk / totalVolume) * 100 : 0}%"></div>
          </div>
        </div>
      </div>
    </div>
